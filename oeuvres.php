...
// Tableau des oeuvres 'tableau associatif dans un tableau
...
$oeuvres = [
    ...
    [
        ...
        "description" => "Quisque accumsan ultrices ligula vestibulum posuere. Aliquam feugiat ligula eget massa blandit condimentum. Morbi volutpat erat luctus suscipit pellentesque. Quisque cursus tempor nibh at sollicitudin. Sed blandit libero velit. Etiam tincoeuvreunt facilisis mollis. Ut mollis nunc sit amet lacinia luctus. Suspendisse volutpat enim semper arcu rutrum, et iaculis risus interdum. Duis at libero.",
        "URL" => "oeuvre.php?id=3",
        "is_enabled" => true,
    ],
    ...
    [
        ...
        "author" => "Hamish McKee",
        "description" => "Integer in nisl posuere, pulvinar ex ac, tincoeuvreunt risus. Nullam vel lorem et leo dignissim accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempor, magna non consectetur dapibus, est libero iaculis lacus, eget semper turpis orci vitae felis. Fusce eget molestie.",
        "URL" => "oeuvre.php?id=7",
        "is_enabled" => true,],
    ...
    [
        ...
        "description" => "Nunc fermentum purus dapibus justo fermentum auctor. Maecenas non tincoeuvreunt leo. Morbi vitae iaculis sem. Donec quis scelerisque massa. Fusce quis accumsan diam, et interdum lectus. Suspendisse mattis pulvinar vehicula. Duis nisi.",
        "URL" => "oeuvre.php?id=8",
        "is_enabled" => true,
    ],
    ...
    [
        ...
        "description" => "Vivamus quis odio vel ligula feugiat facilisis. Donec eleifend pellentesque massa, ut malesuada est bibendum sit amet. Morbi tincoeuvreunt nec tellus vel ornare. Mauris dolor tellus, gravoeuvrea eget euismod eu, viverra eget urna. Phasellus feugiat ipsum nec lorem accumsan, sed porta quam dictum massa nunc.",
        "URL" => "oeuvre.php?id=10",
        "is_enabled" => true,
    ],
    ...
    [
        ...
        "description" => "Mauris ut justo ac mi pretium eleifend. Curabitur sed magna ut elit facilisis pharetra. Maecenas tincoeuvreunt fermentum ipsum ut sollicitudin. Nullam feugiat, neque vel egestas sollicitudin, quam leo mattis mauris, in lacinia sem mi id risus. Nullam ultrices quam eu leo auctor tempus. Fusce vestibulum mi ex, vel ultricies purus mollis sollicitudin. Aenean ac vehicula ipsum. Nam turpis ante, ultrices eget odio sed, luctus bibendum mauris sodales sed.",
        "URL" => "oeuvre.php?id=11",
        "is_enabled" => true,
    ],
    ...
    [
        ...
        "description" => "Donec semper a massa quis congue. In malesuada lorem ligula, ut posuere magna pulvinar in. Proin vitae enim gravoeuvrea, commodo odio.",
        "URL" => "oeuvre.php?id=13",
        "is_enabled" => true,
    ],
    ...
    [
        ...
        "author" => "Adelheoeuvre Von Schreiber",
        ...
        "URL" => "oeuvre.php?id=15",
        "is_enabled" => true,
    ],

];

// Pour ajouter une oeuvre suffit simplement de dupliquer un des tableaux et de changer les valeurs
